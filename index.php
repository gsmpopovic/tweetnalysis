            ...
            <div class="col-md-6">
                <div class="col-md-9 h-40">
                    <div class="card">
                        <div class="card-body">
                            <p>
                                Tweetnalysis is a web application that retrieves tweets from a handle's timeline utilizing access to Twitter's API and analyzes their sentiment (the author's mood and attitude, as evidenced by their use of language). The PHP library is
